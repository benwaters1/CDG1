...
FR = {
    ...
    "Weddings & Celebrations": "Mariages et célébrations",
    "Weddings": "Mariages",
    ...
    "Rooms": "Chambres",
    "Occupied": "Occupée",
    "Needs turning over": "À remettre en état",
    "Ready, guest today": "Prête, arrivée aujourd'hui",
    "Ready": "Prête",
    ...
    # ------------------------------------------------------------------
    # From the design side's fr.json, 88 strings this table did not have.
    # Only the ones that were MISSING: 34 of the 118 we both had are worded
    # differently — 'Célébrations' against 'Réceptions', 'par nuit' against
    # 'la nuit' — and both are good French. Overwriting a translation that
    # is already here would be a copy decision rather than a merge, so the
    # existing wording stands until somebody chooses.
    # ------------------------------------------------------------------
    'Adults': 'Adultes',
    ...
    'Balance': 'Solde',
    'Balance due': 'Solde à régler',
    'Book in': 'Réserver',
    'Cancelled': 'Annulée',
    'Confirmed': 'Confirmée',
    'Departure date': 'Date de départ',
    'Deposit': 'Acompte',
    'Dietary notes': 'Régime alimentaire',
    'Exclusive hire': 'Privatisation',
    'Expected guests': 'Nombre de personnes attendu',
    'Follow the Restoration': 'Suivre la restauration',
    'Full name': 'Nom complet',
    'Guest': 'Voyageur',
    'Home': 'Accueil',
    'How many nights': 'Nombre de nuits',
    'Manage a reservation': 'Gérer une réservation',
    'Medical notes': 'Informations médicales',
    'Message': 'Message',
    'More': 'Plus',
    'Need something for your stay?': 'Besoin de quelque chose pour votre séjour ?',
    'Next': 'Suivant',
    'Night': 'Nuit',
    'Nights': 'Nuits',
    'No': 'Non',
    'No more than a few times a year.': 'Quelques fois par an, pas davantage.',
    ...
    'Per night': 'La nuit',
    'Phone optional': 'Téléphone (facultatif)',
    'Photography & film': 'Photographie et tournage',
    'Please choose': 'Veuillez choisir',
    'Preferred date': 'Date souhaitée',
    'Previous': 'Précédent',
    'Privacy': 'Confidentialité',
    'Read along': 'Suivre le journal',
    ...
    'Send this with my enquiry': 'Joindre ceci à ma demande',
    'Sending…': 'Envoi en cours…',
    'Sent when there is something worth sending.': "Envoyé lorsqu'il y a quelque chose à raconter.",
    ...
    'Submit': 'Envoyer',
    'Tell us': 'Dites-nous',
    'Tell us about your event': 'Parlez-nous de votre réception',
    'Terms': 'Conditions',
    'The Journal': 'Le Journal',
    'This room': 'Cette chambre',
    'Time': 'Heure',
    'Under 18': 'Moins de 18 ans',
    'Unsubscribe': 'Se désabonner',
    'Unsubscribe in one click.': 'Désabonnement en un clic.',
    'Update': 'Mettre à jour',
    'View this workshop': 'Voir cet atelier',
    'Wedding': 'Mariage',
    'What can we arrange for you?': 'Que pouvons-nous organiser pour vous ?',
    'What kind of event?': 'Quel type de réception ?',
    'Where to Begin': 'Par où commencer',
    'Workshop': 'Atelier',
    'Write to us': 'Écrivez-nous',
    'Yes': 'Oui',
    'Your past stays': 'Vos séjours précédents',
...
ES = {
    ...
    "Weddings & Celebrations": "Bodas y celebraciones",
    "Weddings": "Bodas",
    ...
    "Rooms": "Habitaciones",
    "Occupied": "Ocupada",
    "Needs turning over": "Pendiente de preparar",
    "Ready, guest today": "Lista, llegada hoy",
    "Ready": "Lista",
